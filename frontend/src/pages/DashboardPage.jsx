    ...
    >
      <div className="pb-16 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start mb-6">
          {/* Left Column (lg:col-span-5): Financial Health & Q&A Metric Cards */}
          ...
          {/* Right Column (lg:col-span-7): Recommended Scheme, AI Advisor & Matched Schemes Directory */}
        ...
        {/* Bottom Full-Width AGMARKNET Live Mandi Raw Material Prices Widget */}
