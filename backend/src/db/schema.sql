...
CREATE TABLE schemes (
    ...
    interest_rate_or_subsidy_en VARCHAR(255),
    interest_rate_or_subsidy_hi VARCHAR(255),
    documentation_complexity VARCHAR(50) DEFAULT 'simple',
    avg_processing_time_en VARCHAR(100),
    avg_processing_time_hi VARCHAR(100),
    tenure_en VARCHAR(100),
    tenure_hi VARCHAR(100),
    required_docs_count INTEGER DEFAULT 2,
    required_docs_en TEXT[],
    required_docs_hi TEXT[],
    key_eligibility_en TEXT,
    key_eligibility_hi TEXT,
    best_fit_for_en TEXT,
    best_fit_for_hi TEXT,
