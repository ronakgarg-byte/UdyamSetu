  ...
  initMasterData() {
    ...
    this.schemes = [
      ...
      },
      {
        ...
        min_revenue_threshold: 0,
        max_revenue_threshold: null,
        target_problems: ['unknown', 'workingcap', 'marketing'],
        target_genders: ['male', 'female', 'other'],
        base_eligibility_score: 95,
        details_url: 'https://udyamregistration.gov.in/',
      },
      {
        id: '9',
        code: 'pmkvy',
        ...
        min_revenue_threshold: 0,
        max_revenue_threshold: null,
        target_problems: ['unknown', 'employees'],
        target_genders: ['male', 'female', 'other'],
        base_eligibility_score: 90,
        details_url: 'https://www.pmkvyofficial.org/',
      },
    ];
  }
}
